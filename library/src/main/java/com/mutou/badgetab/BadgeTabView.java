...
public class BadgeTabView extends RelativeLayout {
    ...
    public BadgeTabView(Context context, AttributeSet attrs, int defStyle) {
        ...
        ColorStateList textColor = ta.getColorStateList(R.styleable.BadgeTabView_textColor);
        int textSize = ta.getDimensionPixelSize(R.styleable.BadgeTabView_textSize, 0);
